...
class VlcNode:
    ...
    def handle_play_stream(self, blah):
        self.server.play()

    def handle_pause_stream(self, blah):
        self.server.pause()

    def handle_stop_stream(self, blah):
        self.server.stop()

    def handle_start_record(self, blah):
        self.recorder.start_record()

    def handle_stop_record(self, blah):
